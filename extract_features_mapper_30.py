...
features_file_name = app_directory + '/csv_files/unsw_dataset_features_30m.csv'
...
mapping = pd.read_csv(app_directory + '/csv_files/unsw_dataset_features_30m.csv')
mapped = mapping.merge(mac_source, on='device_co', how='left').rename(columns={'MAC Address':'MAC_address'})
mapped.to_csv(app_directory + "/csv_files/unsw_dataset_features_mapped_30m.csv",index=False)
print("Done.")
'''
